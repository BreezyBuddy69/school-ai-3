...
└───────┴───────┘
    a       b
```
Gesamtfläche: $(a+b)^2$ = Summe der 4 Teilflächen = $a^2 + ab + ab + b^2 = a^2 + 2ab + b^2$

## Anwendung: Ausmultiplizieren (Beispiele)
```
...
## Anwendung: Faktorisieren (Rückrichtung)
Das Erkennen einer binomischen Formel im Term hilft, ihn als Produkt zu schreiben — wichtig, um später Nullstellen einer quadratischen Funktion direkt abzulesen.

```
x² + 6x + 9   = (x + 3)²         (a=x, b=3, mittlerer Term passt: 2·x·3=6x)
x² - 4x + 4   = (x - 2)²
x² - 16       = (x + 4)(x - 4)   (3. binomische Formel rückwärts)
4x² - 25      = (2x + 5)(2x - 5)
```
...
## Zusammenfassung
$$\boxed{(a+b)^2 = a^2+2ab+b^2 \qquad (a-b)^2 = a^2-2ab+b^2 \qquad (a+b)(a-b) = a^2-b^2}$$

> Merke: Diese drei Formeln brauchst du ab jetzt ständig — beim Lösen von Gleichungen, beim Kürzen von Bruchtermen und später beim Bestimmen von Nullstellen quadratischer Funktionen (Jahr 5).
